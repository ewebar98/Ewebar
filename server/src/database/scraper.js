      ...
      if (isUni) {
        if (nameLower.includes("lagos state university of science and technology") || nameLower.includes("lasustech")) {
          matchedTemplates = [
            ...
            { name: "Computer Application Technology", faculty: "College of Engineering & Technology", duration: "5 years", cutoffMark: 200, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Chemistry"], careerPaths: ["System Developer", "IT Architect"], description: "Software development, network management, systems design, and database services." },
            { name: "Electrical & Electronics Engineering", faculty: "College of Engineering & Technology", duration: "5 years", cutoffMark: 215, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Chemistry"], careerPaths: ["Electrical Engineer", "Hardware Developer"], description: "Power systems, circuits, telecommunications, and electronics designs." },
            { name: "Mechanical Engineering", faculty: "College of Engineering & Technology", duration: "5 years", cutoffMark: 215, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Chemistry"], careerPaths: ["Mechanical Engineer", "Industrial Automator"], description: "Fluid systems, thermodynamics, mechanics, and product manufacturing." },
            { name: "Mechatronics Engineering", faculty: "College of Engineering & Technology", duration: "5 years", cutoffMark: 220, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Chemistry"], careerPaths: ["Robotics Engineer", "Control Systems Designer"], description: "Integration of mechanical systems, microelectronics, and advanced software layers." },

            // College of Environmental Design & Technology
            { name: "Architecture", faculty: "College of Environmental Design & Technology", duration: "5 years", cutoffMark: 220, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Technical Drawing"], careerPaths: ["Architect", "CAD Drafter"], description: "Creative and structural design of building layouts and aesthetic architectures." },
            { name: "Arts & Industrial Design", faculty: "College of Environmental Design & Technology", duration: "4 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["English", "Fine Arts", "History", "Literature"], careerPaths: ["Industrial Designer", "Creative Lead"], description: "Product styling, ceramics, graphics, textile prints, and aesthetic design." },
            ...
            { name: "Estate Management & Valuation", faculty: "College of Environmental Design & Technology", duration: "5 years", cutoffMark: 185, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Geography"], careerPaths: ["Property Valuer", "Real Estate Manager"], description: "Property valuation models, property law, facility management, and investment portfolios." },
            { name: "Quantity Surveying", faculty: "College of Environmental Design & Technology", duration: "5 years", cutoffMark: 185, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Geography"], careerPaths: ["Quantity Surveyor", "Cost Estimator"], description: "Material estimation, bill of quantities preparation, and project budgeting." },
            { name: "Urban & Regional Planning", faculty: "College of Environmental Design & Technology", duration: "5 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Geography", "Economics"], careerPaths: ["Town Planner", "Zoning Officer"], description: "Zoning regulations, city infrastructure routing, and transport plans." },

            // College of Basic Sciences
            { name: "Biological Sciences", faculty: "College of Basic Sciences", duration: "4 years", cutoffMark: 190, tuition: "₦105,000/yr", requirements: ["Biology", "English", "Chemistry", "Physics"], careerPaths: ["Biologist", "Environmental Inspector"], description: "Study of life, biodiversity, ecology, botany, and zoological systems." },
            { name: "Chemical Sciences", faculty: "College of Basic Sciences", duration: "4 years", cutoffMark: 190, tuition: "₦105,000/yr", requirements: ["Chemistry", "English", "Physics", "Mathematics"], careerPaths: ["Chemist", "Laboratory Manager"], description: "Pure and industrial chemical analysis, transformations, and compound designs." },
            { name: "Computer Science", faculty: "College of Basic Sciences", duration: "4 years", cutoffMark: 225, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Physics", "Chemistry"], careerPaths: ["Software Engineer", "Database Specialist"], description: "Database logic, software engineering patterns, coding, and artificial intelligence." },
            ...
            { name: "Microbiology", faculty: "College of Basic Sciences", duration: "4 years", cutoffMark: 200, tuition: "₦105,000/yr", requirements: ["Biology", "English", "Chemistry", "Physics"], careerPaths: ["Lab Scientist", "Food Safety Officer"], description: "Microscopic life study, clinical pathogen diagnostics, and food microbiology." },
            { name: "Physics with Electronics", faculty: "College of Basic Sciences", duration: "4 years", cutoffMark: 185, tuition: "₦105,000/yr", requirements: ["Physics", "English", "Mathematics", "Chemistry"], careerPaths: ["Hardware Technician", "Telecomm Lead"], description: "Applied physics focusing on electrical circuits and semiconductor logics." },
            { name: "Statistics", faculty: "College of Basic Sciences", duration: "4 years", cutoffMark: 185, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Physics"], careerPaths: ["Statistician", "Data Analyst"], description: "Probability, statistical modeling, data surveys, and planning frameworks." },

            // College of Applied Social Sciences
            { name: "Accounting", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 215, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Government"], careerPaths: ["Accountant", "Internal Auditor"], description: "Financial audits, ledger preparation, corporate taxes, and accounting frameworks." },
            { name: "Actuarial Science", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 195, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Government"], careerPaths: ["Actuary", "Risk Consultant"], description: "Risk analysis, insurance mathematics, pension funds, and financial predictions." },
            { name: "Banking & Finance", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 200, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Government"], careerPaths: ["Investment Banker", "Credit Officer"], description: "Commercial banking, investment markets, public finance, and credit operations." },
            { name: "Business Administration", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 205, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Government"], careerPaths: ["Business Administrator", "Operations Specialist"], description: "Corporate administration, human resource models, and operations management." },
            { name: "Economic Science", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 210, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Government"], careerPaths: ["Economic Analyst", "Policy Strategist"], description: "Micro and macro economics, financial markets, and statistical planning." },
            { name: "Marketing", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 185, tuition: "₦105,000/yr", requirements: ["Mathematics", "English", "Economics", "Commerce"], careerPaths: ["Brand Manager", "Sales Representative"], description: "Digital brand growth, market research, and customer relationship logic." },
            { name: "Mass Communication Science & Technology", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 215, tuition: "₦105,000/yr", requirements: ["Literature", "English", "Government", "History"], careerPaths: ["Journalist", "PR Representative"], description: "Journalism, public relations, broadcast technologies, and printing systems." },
            { name: "Office & Information Technology", faculty: "College of Applied Social Sciences", duration: "4 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["English", "Mathematics", "Commerce", "Government"], careerPaths: ["Administrative Lead", "Office Coordinator"], description: "Office systems, databases, typing speed mastery, and communications." },

            // College of Agriculture
            { name: "Agricultural Economics & Farm Management", faculty: "College of Agriculture", duration: "5 years", cutoffMark: 185, tuition: "₦105,000/yr", requirements: ["Agricultural Science", "English", "Economics", "Mathematics"], careerPaths: ["Farm Manager", "Agribusiness Consultant"], description: "Agribusiness budgeting, credit options, and strategic farm management." },
            { name: "Agricultural Extension & Rural Development", faculty: "College of Agriculture", duration: "5 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["Agricultural Science", "English", "Biology", "Chemistry"], careerPaths: ["Extension Agent", "Rural Development Planner"], description: "Farming methods education, rural social structures, and extension services." },
            { name: "Animal Production", faculty: "College of Agriculture", duration: "5 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["Biology", "English", "Agricultural Science", "Chemistry"], careerPaths: ["Poultry Manager", "Animal Nutritionist"], description: "Livestock breeding, feeds compounding, and farm animal operations." },
            { name: "Aquaculture & Fisheries Management", faculty: "College of Agriculture", duration: "5 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["Biology", "English", "Agricultural Science", "Chemistry"], careerPaths: ["Fish Breeder", "Hatchery Technologist"], description: "Fish pond constructions, feeds formulation, and water chemistry models." },
            { name: "Crop Production", faculty: "College of Agriculture", duration: "5 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["Biology", "English", "Agricultural Science", "Chemistry"], careerPaths: ["Crop Scientist", "Plant Valuer"], description: "Plant genetics, seed breeding, weed controls, and crop protections." },
            { name: "Horticulture & Landscape Management", faculty: "College of Agriculture", duration: "5 years", cutoffMark: 180, tuition: "₦105,000/yr", requirements: ["Biology", "English", "Agricultural Science", "Chemistry"], careerPaths: ["Landscape Designer", "Garden Consultant"], description: "Cultivation of flowers, garden layouts, landscape architecture, and botany." },
          ];
